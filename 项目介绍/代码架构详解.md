...
**涉及文件**：`backend/app/main.py`, `backend/app/config.py`, `backend/app/api/*.py`, `backend/app/services/*.py`, `backend/app/workflow/*.py`
...
**涉及文件**：`backend/app/workflow/state.py`, `backend/app/workflow/graph.py`, `backend/app/workflow/nodes.py`
...
**文件位置**：`backend/app/workflow/graph.py`
...
**文件位置**：`backend/app/workflow/nodes.py:84-161`
...
**文件位置**：`backend/app/services/research_service.py`
...
**文件位置**：`backend/app/api/research.py`
...
**文件位置**：`backend/app/api/research.py:126-200`
...
**文件位置**：`frontend/src/stores/research.js`
